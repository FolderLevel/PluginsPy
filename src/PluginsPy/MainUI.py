...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.PSRegexSavePushButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.PSRegexSavePushButton.sizePolicy().hasHeightForWidth())
        self.PSRegexSavePushButton.setSizePolicy(sizePolicy)
        self.PSRegexSavePushButton.setObjectName("PSRegexSavePushButton")
        self.horizontalLayout_2.addWidget(self.PSRegexSavePushButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.PSRegexSavePushButton.setText(_translate("MainWindow", "Save"))
